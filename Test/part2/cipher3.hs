...
filesmallreplaced filetemp dict file = (replaceWithKey (finalkey filetemp dict) (replaceourkey file))
...
main = do
        ...
        --nayimasti (replaceourkeycapital (filesmallreplaced filetemp dict file))
